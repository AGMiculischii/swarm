...
def get_ports():
    if sys.platform.startswith('win32'):
        com_ports = [(name, desc.encode('utf-16-be').decode('cp1251'), v_p) for name, desc, v_p in serial.tools.list_ports.comports()]
...
class SwarmNode(SerCom):
    ...
    def __display_rato(self):
        ...
        out_str = colorama.Style.BRIGHT + colorama.Fore.CYAN + "Current distance: {:>5.2f} m".format(dist) + colorama.Style.RESET_ALL
